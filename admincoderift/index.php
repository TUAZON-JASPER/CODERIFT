...
<head>
    ...
    <style>
        ...
        .navbar { background-color: #800000; }
        .navbar-light .navbar-nav .nav-link { color: white; }
        .navbar-light .navbar-nav .nav-link:hover { color: #ffd700; }
        .navbar-brand { color: white; }
        .content { margin-top: 80px; }
        .nav-pills .nav-link.active { background-color: #800000; }
        .nav-pills .nav-link { border-radius: 0; color: #800000; }
        .nav-pills .nav-link:hover { color: #ffd700; }
    </style>
</head>
<body>
        ...
        <div class="container mt-4">
            <ul class="nav nav-pills mb-3" id="dashboardTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="questions-tab" data-bs-toggle="pill" href="#questions" role="tab" aria-controls="questions" aria-selected="true">Manage Questions</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="lessons-tab" data-bs-toggle="pill" href="#lessons" role="tab" aria-controls="lessons" aria-selected="false">Manage Lessons</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="students-tab" data-bs-toggle="pill" href="#students" role="tab" aria-controls="students" aria-selected="false">View Students</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="analytics-tab" data-bs-toggle="pill" href="#analytics" role="tab" aria-controls="analytics" aria-selected="false">Analytics</a>
                </li>
            </ul>
            ...
            <div class="tab-content" id="dashboardTabsContent">
                ...
                <div class="tab-pane fade show active" id="questions" role="tabpanel" aria-labelledby="questions-tab">
                    ...
                    <button class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#addQuestionModal">Add New Question</button>
                ...
                <div class="tab-pane fade" id="lessons" role="tabpanel" aria-labelledby="lessons-tab">
                    ...
                    <button class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#addLessonModal">Add New Lesson</button>
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th>ID</th>
